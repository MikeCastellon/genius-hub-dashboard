    ...
    <div className="p-4 md:p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-violet-500 to-purple-500 text-white text-xs font-semibold shadow-md shadow-violet-500/25 hover:shadow-lg transition-all"
        >
          <Plus size={14} />
        ...
        <div className="glass rounded-2xl p-4 mb-6 space-y-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3.5 py-2.5 rounded-xl border border-zinc-200 bg-white text-sm text-zinc-900 placeholder:text-zinc-300 focus:outline-none focus:border-violet-300 focus:ring-2 focus:ring-violet-500/10"
            />
            <button
              onClick={handleAdd}
              disabled={adding || !newName.trim()}
              className="px-4 py-2 rounded-xl bg-gradient-to-r from-violet-500 to-purple-500 text-white text-xs font-semibold disabled:opacity-40"
            >
